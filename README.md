...
we keep the original data format used by earlier DTA works (e.g., DeepDTA / GraphDTA) for reference:
```text
data/
├── davis/
│   ├── Y
